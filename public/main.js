...
const sampleCampaigns = [
    { level: 1, status: 'current', title: '🇮🇳 Ludo Practice Arena', desc: 'Hone your skills against local computer players and collect points on the board. Level 1 is the free way in.' },
    { level: 2, status: 'current', title: '🇳🇬 Active Daily Airtime Cup', desc: 'Pool active! Top 8 leaderboard winners share a mobile recharge reward.' },
    { level: 2, status: 'upcoming', title: '🇳🇬 Tomorrow Airtime Sprint', desc: 'Pool lock initializes at 08:00. Secure your eligibility balance tokens.' },
