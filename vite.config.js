  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'changelog-architecture-v2-m1': './changelog/architecture-v2-m1.html',
        'changelog-architecture-v2-m2': './changelog/architecture-v2-m2.html',
        'changelog-architecture-v2-m3': './changelog/architecture-v2-m3.html',
        'changelog-architecture-v2-m4': './changelog/architecture-v2-m4.html',
        'changelog-architecture-v2-m5': './changelog/architecture-v2-m5.html',
        'changelog-architecture-v2-m6': './changelog/architecture-v2-m6.html',
        'changelog-architecture-v2-m7': './changelog/architecture-v2-m7.html',
        'changelog-architecture-v2-m8': './changelog/architecture-v2-m8.html',
        'changelog-architecture-v2-m9': './changelog/architecture-v2-m9.html',
        'changelog-architecture-v2-m10': './changelog/architecture-v2-m10.html',
        'changelog-architecture-v2-m11': './changelog/architecture-v2-m11.html',
        'changelog-architecture-v2-m12': './changelog/architecture-v2-m12.html',
